...
<body style="background-color: rgb(6, 6, 25);">
    ...
    <script nomodule src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.js"></script>
      ...
      <h2 class="text" style="position: relative; color: white; top: 100px; margin-right: 200px;">Transaction History</h2>
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center">
        ...
        <div style="text-align: center;" class="row">
            <div class="col-12">
                ...
                <h1 style="padding-top: 25%"><strong>You Have No History Right Now.</strong></h1>
