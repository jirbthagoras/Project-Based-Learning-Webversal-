...
<body style="background-color: rgb(6, 6, 25);">
    ...
    <script nomodule src="https://unpkg.com/ionicons@7.1.0/dist/ionicons/ionicons.js"></script>
      ...
      <h2 class="text" style="position: relative; color: white; top: 100px; margin-right: 200px">YOUR DRAFTS</h2>
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center">
        ...
        <div class="row">
            <div style="text-align: center" class="col-12">
                ...
                <table class="table table-border" style="text-wrap: auto; border-collapse: collapse; width: 100%; margin-top: 20px;">
                    <thead>
                    ...
                    <?php foreach($model["result"] as $set):?>
                        <tr>
                            ...
                            <td> <?= $set['code'] ?> </td>
                            <td>
                                <div style="text-wrap: auto"> <?= $set['description'] ?> </div>
                            </td>
                            <td class="tom">
                                <a href="/public/draft/undraft/code/<?= $set['code'] ?>"><button style="background: rgba(96, 112, 255, 0.2); border: none; border-radius: 5px; font-family: sans-serif; width: 140px;
                            ">Undraft</button></a>
                            </td>
                            <td class="tom">
                                <a href="/public/draft/delete/code/<?= $set['code'] ?>"><button style="background: rgba(96, 112, 255, 0.2); border: none; border-radius: 5px; font-family: sans-serif; width: 140px;
                            ">Delete</button></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    <?php else: ?>
                        ...
                        <h1 style="padding-top: 25%"><strong>You Have No Drafts Right Now.</strong></h1>
